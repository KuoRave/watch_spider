...
class ScraperPipeline(object):
    ...
    def dealBrand(self, cursor, item):
        ...
        cursor.execute("SELECT id,img_uri FROM watch_brand WHERE `name`='%s' OR `name_en`='%s'" % (brand_obj['name'], brand_obj['name_en']))
        ...
        if brand_result is None:
            ...
            if brand_obj['img_uri'] is not None:
                ...
                brand_line.append(brand_obj['name'])
                brand_line.append(brand_obj['name_en'])
                ...
                cursor.execute("SELECT id FROM watch_brand WHERE `name`='%s' OR `name_en`='%s'" % (brand_obj['name'], brand_obj['name_en']))
                brand_result = cursor.fetchone()
